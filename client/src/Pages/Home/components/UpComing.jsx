...
const UpComing = () => {
  ...
  return (
    <div className="md:w-[1180px] bg-[#212529] mx-auto w-full p-3 ">
      ...
      <div className="p-3 px-9 bg-[#191d20] w-full  gap-1  grid md:grid-cols-8  grid-cols-4 rounded-b-md">
        {item?.map((item, i) => (
          <div key={i} className="flex flex-col  gap-2 mt-3 items-center p-1">
            <div className="avatar">
              <div className="md:w-24 w-16 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2  overflow-hidden ">
                <img
